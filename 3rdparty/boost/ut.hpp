...
#if defined(BOOST_UT_IMPLEMENTATION)
            void on(events::suite<void (*)()> suite)
            {
                cfg<override>.on(suite);
            }
            void on(events::test<void (*)()> test)
            {
                cfg<override>.on(test);
            }
            void on(events::test<utility::function<void()>> test)
            {
                cfg<override>.on(static_cast<decltype(test)&&>(test));
            }
            void on(events::skip<> skip)
            {
                cfg<override>.on(skip);
            }
            [[nodiscard]] auto on(events::assertion<events::expr> assertion) -> bool
            {
                return cfg<override>.on(static_cast<decltype(assertion)&&>(assertion));
            }
            void on(events::fatal_assertion assertion)
            {
                cfg<override>.on(assertion);
            }
            void on(events::log<bool> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<char> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<short> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<int> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<long> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<long long> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<unsigned> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<unsigned char> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<unsigned short> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<unsigned long> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<float> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<double> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<long double> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<const char*> l)
            {
                cfg<override>.on(l);
            }
            void on(events::log<utility::string_view> l)
            {
                cfg<override>.on(l);
            }
#endif
